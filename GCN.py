...
if not os.path.exists(log_dir):
    os.makedirs(log_dir)
log_path = os.path.join(log_dir, 'GCN.log')
...
if __name__ == "__main__":
    ...
    model = GCN(n_homo_features, args.hid_dim)
    ...
    for epoch in range(args.epochs):
        ...
        if results[0] > bestauc:
            bestepoch = epoch
            bestauc = results[0]
            torch.save(model.state_dict(), '/home/zqxu/MHTGNN/model_save/GCN_Xinye_params.pth')
