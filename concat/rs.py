...
if not os.path.exists(log_dir):
    os.makedirs(log_dir)
log_path = os.path.join(log_dir, 'concat_rs.log')
...
def run():
    ...
    embed_table = torch.load("/home/zqxu/MHTGNN/data/embedding/tfencoder_Xinye_rs_embed.pt")
    ...
    for epoch in range(args.epochs):
        ...
        with torch.no_grad():
            ...
            if results[0] > bestauc:
                bestauc = results[0]
                bestepoch = epoch
                torch.save(model.state_dict(), "/home/zqxu/MHTGNN/model_save/IHG_rs_prarams.pth")
